 ...
 <article>
        ...
        <!--  utilisation de la class container ( déjà existante dans bootstrap ! )  -->
        <header class="container">
            
            <h1>Qu'est-ce que le Lorem Ipsum?</h1>
            
            <!--  création d'une variable qui contient la date que l'on lui indique   -->
            <time datetime="2018-03-19" pubdate>18 mars 2018</time>
        ...
        <div class="container">
            ...
            <!--  utilisation de la class row ( déjà existante dans bootstrap ! ) signifie la rangée -->
            <div class="row">
